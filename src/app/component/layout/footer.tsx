            ...
            <div className="max-w-[1250px] mx-auto grid sm:grid-cols-[1fr_2fr] gap-4">
                <div>
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-2 max-w-[280px]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos aliquid assumenda neque dolorem modi</p>
                    </div>
                </div>
                <div className="grid sm:grid-cols-3 sm:gap-2 gap-6">
                    <div>
                        <h3 className="font-semibold pb-1 text-lg">Quick Links</h3>
                        <span className="block w-12 h-[3px] bg-primary-500"></span>
                        <div className="grid gap-2 mt-4 text-green-800">
                            <p className="text-sm">
                    ...
                    <div>
                        <h3 className="font-semibold pb-1 text-lg">Useful Links</h3>
                        <span className="block w-12 h-[3px] bg-primary-500"></span>
                        <div className="grid gap-2 mt-4 text-green-800">
                            <p className="text-sm">
                    ...
                    <div>
                        <h3 className="font-semibold pb-1 text-lg">Contact Us</h3>
                        <span className="block w-12 h-[3px] bg-primary-500"></span>
                        <div className="grid gap-2 mt-4 text-green-800">
