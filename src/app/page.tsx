  ...
  return (
    <>
      <div className="relative bg-black">
        ...
        <div className="absolute sm:top-40 top-20 z-[2] text-center w-full">
          <h2 className="sm:text-[42px] text-2xl font-semibold mb-3 text-white">Welcome to Muslim Community Of India</h2>
          ...
          <h2 className="font-semibold text-white sm:text-4xl text-xl mb-8">والسماء رفعها ووضع الميزان</h2>
          <ThemeButton text="Learn More" />
        </div>
      </div>
      <div className="grid sm:grid-cols-2 items-center px-4 py-16 max-w-[1350px] mx-auto">
